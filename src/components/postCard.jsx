  ...
  return (
    <Link href={`/blog/${slug}+${id}`} className={"flex max-w-xl flex-col items-start "+` ${css}`} >
      <div className="flex h-10 items-center gap-x-4 text-xs">
        ...
        {
          labels ?
            <div className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100 tracking-tight from-[#defbff] to-[#ffdfd2] bg-gradient-to-tl ">
              {labels[0]}
            </div>
            : ""
        }
      ...
      <div className="group relative">
        <h3 className="mt-3 text-lg font-semibold leading-6 text-[#335133] group-hover:text-gray-600">
